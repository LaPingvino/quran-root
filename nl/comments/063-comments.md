...
De wortel ن-ف-ق (huichelarij) betekent tevens een tunnel graven en uitgeven. De huichelaar heeft een tunnel — een vluchtweg, een geheime doorgang tussen twee gezichten.

## Wortelanalyse

### Wortel ن-ف-ق (n-f-q) — "huichelarij, tunnel, uitgeven"
De مُنَافِق heeft twee openingen: één gericht op de gelovigen, één op de vijand. V.4: "Zij zijn als gesteunde balken" — indrukwekkend van buiten, hol van binnen. De drievoudige betekenis der wortel (uitgeven, tunnelen, huichelen) suggereert dat oprecht uitgeven (van vermogen, van zichzelf) het tegengif is voor huichelarij.

### v.3: Wortel ط-ب-ع (th-b-ayn) — "verzegelen"
...
### v.9: Wortel ذ-ك-ر (dh-k-r) — "herinnering"
