...
### Wortel ح-ي-ي (h-j-j) — leven en geestelijk ontwaken

De wortel draagt de soera als kernbetoog:
...
### Wortel ز-و-ج (z-w-dj) — paren (v.36)
...
### Wortel خ-ت-م (kh-t-m) — verzegeling (v.65)

"Heden verzegelen Wij hun monden" — dezelfde wortel als 33:40 ("Zegel der Profeten"). Het zegel sluit en bekrachtigt tegelijk: de verzegelde mond kan niet liegen, en het getuigenis der handen is door het zegel gewaarborgd.

### Wortel ك-و-ن (k-w-n) — "Wees!" (v.82)
...
- **V.12**: Aathaar (sporen, wortel أ-ث-ر) breidt verantwoordelijkheid uit voorbij daden tot hun gevolgen — de rimpeleffecten.
...
- **V.80**: "Van de groene boom, vuur" — de wortel kh-d-r (frisheid). Uit het frisse, levende hout komt vuur — verbonden met 55:15 (djinn geschapen uit vuurstroom) en 55:76 (frisse kussens).
...
- V.65 verzegeling verhoudt zich tot 33:40 — dezelfde wortel (kh-t-m) op oordeel en profetengeschiedenis toegepast.
